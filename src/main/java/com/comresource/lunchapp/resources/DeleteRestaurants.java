...
public class DeleteRestaurants {
    ...
    public void create(String restaurant) throws Exception {
        ...
        //GET File ID
        final String restaurantsId = (String) restaurantJSON.get("restaurantsId");
        try {
            entityManager.getTransaction().begin();
            // Find the File in the database
            Restaurants found = entityManager.find(Restaurants.class, restaurantsId);
            if (found == null) {
                throw new PersistenceException("Restaurant with key: " + restaurantsId + " not found.");
            }
            // Delete Row
